...
export default function EditDeviceDialog({
 ...
 const handleConfirm = async () => {
   ...
   const deviceTypeError = validateRequired(editedData.deviceType, "ประเภทอุปกรณ์");
   const userNameError = validateRequired(editedData.userName, "ชื่อผู้นำเข้า");
   ...
   if (deviceIdError || deviceTypeError || userNameError || locationError || dateError) {
     setErrors({
       ...
       <DialogContent sx={{ 
         ...
         <Box component="form" sx={{ mt: 2 }}>
           ...
           <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale="th">
             <DatePicker
               label="วันที่นำเข้า"
               value={editedData.installDate ? dayjs(editedData.installDate, "DD/MM/YYYY") : null}
               onChange={(newValue) => {
                 setEditedData(prev => ({
                   ...prev,
                   installDate: newValue ? newValue.format("DD/MM/YYYY") : ""
                 }));
